...
const Personal = () => {
  const styles = {
    ...
    personal__btn: 'intro__left--button text-maintext px-6 py-4 bg-mainbggreen w-max mt-12 rounded  uppercase tracking-[1px] lg:mt-8  transition-all duration-500 hover:bg-maintextwhite hover:text-mainbggreen',
    ...
    <div className={styles.personal}>
      <div className={styles.container}>
        <div className={styles.personal__container}>
          <div className="personal__left w930:hidden" data-aos="fade-right">
            <img src={PersonalHero} alt="hero" />
          </div>
          <div className={styles.personal__right} data-aos="fade-left">
