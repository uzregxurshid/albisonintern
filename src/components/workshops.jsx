const Workshops = () => {
  const styles = {
    ...
    workshops__button: "workshops__btn text-maintext px-6 py-4 bg-mainbggreen w-max mt-12 rounded lg:mt-10 uppercase tracking-[1px] text-center",
    workshops__main: "workshops__main flex",
    workshops__list: "workshops__list flex first:ml-0 mt-20 w1050:flex-wrap w1050:justify-center w850px:grid grid-cols-2 grid-rows-1 gap-0 w850:w-[400px] w375:w-[320px]",
  ...
  return (
    <div className={styles.workshops}>
      <div className={styles.container}>
        <div className={styles.workshops__container}>
