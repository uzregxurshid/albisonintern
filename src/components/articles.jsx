...
const Artic = () => {
  ...
  const styles =  {
    ...
    articles__button: "articles__btn text-maintext px-6 py-4 bg-mainbggreen w-max mt-12 rounded lg:mt-10 uppercase tracking-[1px] text-center  transition-all duration-500 hover:bg-maintext hover:text-mainbggreen",
  ...
  return (
    <div className={styles.articles}>
      <div className={styles.container}>
        <div className={styles.articles__container} data-aos="fade-up">
