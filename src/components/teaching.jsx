...
const Teaching = () => {
  const styles= {
    ...
    teaching__btn: 'intro__left--button text-maintext px-6 py-4 bg-mainbggreen w-max mt-12 rounded  uppercase tracking-[1px] lg:mt-8',
    ...
    <div className={styles.teaching}>
      <div className={styles.container}>
        <div className={styles.teaching__container}>
          <div className="teaching__left w930:hidden">
            <img src={TeachingHero} alt="hero" />
          </div>
          <div className={styles.teaching__right}>
