...
const styles = {
  ...
  contact__button: 'w475:w-[310px] w475:ml-0 ml-4 w-[116px] h-16 rounded bg-maintext text-mainbggreen text-center leading-[53px] text-[20px] font-bold mt-[57px]  transition-all duration-500 hover:bg-maintextwhite hover:text-maintext',
